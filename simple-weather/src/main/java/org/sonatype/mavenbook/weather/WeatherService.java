...
public class WeatherService {
	...
	public Weather retrieveForecast(String woeid) throws Exception {
		// Retrieve Data
		InputStream dataIn = yahooRetriever.retrieve(woeid);

		// Parse DataS
		Weather weather = yahooParser.parse(woeid, dataIn);
